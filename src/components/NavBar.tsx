...
import More2 from "@/app/public/More2"
...
const NavBar: React.FC<NavBarProps> = ({ title, login }) => {
    ...
    return (
        <article className="relative">
            ...
            <nav className="flex justify-between mediaNav fixed px-4 items-center bg-transparent w-full py-4 h-14">
                {login ? (
                    <article className="mediaArticleNav">
                        ...
                        <section onClick={() => change()} className="stc mediaMoreNav opacity-0  hidden cursor-pointer relative bg-transparent mr-[6px] justify-center items-center w-full rounded-lg h-12">
                            <More2 />
