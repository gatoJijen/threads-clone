...
const Search = () => {
  return (
    <article className='flex items-center background-2 h-[45px] px-6 py-2 w-[90%] mediaSearchInput mt-[24px] border border-white border-opacity-20  rounded-2xl gap-[10px]'>
        <button>
          <SearchInput/>
        </button>
