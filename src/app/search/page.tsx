    ...
    <section>
      ...
      <article className="flex background-2 w-full h-svh">
        ...
        <section className="flex w-full h-full items-center gap-8 justify-between">
          <SideBar web={false} login={false} webS={false} webH={false} webP={false} webST={false} activeS={true} activeH={false} activeP={false} activeT={false} activeST={false} />
          <article className="w-full background-2 h-[80%] mediaArtContMain mt-[19.6svh] ml-[26%] overflow-hidden">
            <ContMain web={false} webS={false} webH={false} webP={false} webST={false} activeS={true} activeH={false} activeP={false} activeT={false} activeST={false} />
          </article>
        </section>
      </article>
    </section>
