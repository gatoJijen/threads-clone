...
const NameUserPerfil = () => {
    return (
        <svg aria-label="" role="img" viewBox="0 0 26 26" className="fill-transparent h-[20px] w-[20px]">
            <title></title>
            ...
            <path d="M21.75 4.25L13.75 12.25" stroke="currentColor" strokeLinecap="round" strokeWidth="2.5">
            </path>
        </svg>
    )
}

export default NameUserPerfil